...
<script>
  ...
  function spawnReverseEnemy() {{
      ...
      let ex = cameraX - 60; let ey = BASE_GROUND_Y - 52; if (type === 'flying') ey = Math.random() * 200 + 50;
      enemies.push({{ x: ex, y: ey, width: 52, height: 52, dx: finalSpeed, dy: 0, type: 'hard', angle: 0, animIndex: 0, animTimer: 0, isReverse: true }});
  }}
